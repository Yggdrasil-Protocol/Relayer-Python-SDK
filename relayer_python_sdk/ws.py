...
class RelayerWS:
    ...
    Args:
        ...
        logger ``(logging.Logger | NoneType)``: Logger object to log messages. If None, a new default logger is created.
            ...
            async for message in ws:
                ...
                match event:
                    case events.DataFeed():
                        await self.on_price_event_fn(event)
